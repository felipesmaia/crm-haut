...
import { Edit2, Phone, Mail, MapPin, Clock, Globe, Heart, Send, Check, ArrowLeft, ChevronRight } from 'lucide-react';
    ...
    <div className="animate-fade-in max-w-6xl mx-auto pb-10">
      ...
      <div className="bg-white rounded-2xl border border-gray-200 p-6 shadow-sm mb-6">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <div className="flex items-center gap-6">
                ...
                <div>
                    ...
                    <div className="flex items-center gap-3 mt-1 text-gray-500 text-sm">
                        ...
                        <span className="bg-green-100 text-green-700 px-2 py-0.5 rounded text-xs font-semibold">{lead.tags[0] || 'Lead'}</span>
                    </div>
            ...
            <div className="flex gap-3">
                <button className="flex items-center gap-2 px-4 py-2 border border-gray-200 rounded-lg font-medium text-gray-700 hover:bg-gray-50 transition-colors">
                    <Edit2 size={16} /> Editar Perfil
                </button>
                <button className="flex items-center gap-2 px-4 py-2 bg-green-500 hover:bg-green-600 text-white rounded-lg font-medium shadow-sm transition-colors shadow-green-200">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-6">
             <div className="bg-white rounded-2xl border border-gray-200 p-6 shadow-sm">
                ...
                <div className="space-y-4">
                    ...
                    <div className="flex items-start gap-4">
                        ...
                        <div>
                            <p className="text-xs font-bold text-gray-400 uppercase tracking-wider">Social</p>
                            <div className="flex gap-3 text-sm font-medium text-green-600">
             ...
             <button className="w-full py-4 bg-green-500 hover:bg-green-600 text-white font-bold rounded-xl shadow-lg shadow-green-200 flex items-center justify-center gap-2 transition-all transform hover:scale-[1.02]">
        ...
        <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white rounded-2xl border border-gray-200 shadow-sm flex flex-col h-[400px]">
                ...
                <div className="flex-1 overflow-y-auto p-6 space-y-4 bg-gray-50/30">
                    {lead.notes.length === 0 && <p className="text-center text-gray-400 text-sm mt-10">Nenhuma nota ainda. Comece a discussão.</p>}
                    {lead.notes.map(note => (
                        <div key={note.id} className={`flex gap-3 ${note.isMe ? 'justify-end' : 'justify-start'}`}>
                            ...
                            <div className={`max-w-[80%] p-4 rounded-2xl text-sm ${note.isMe ? 'bg-white border border-gray-200 rounded-tr-none' : 'bg-gray-100 rounded-tl-none text-gray-800'}`}>
                                <p className="text-gray-700 leading-relaxed">{note.content}</p>
                                <div className="mt-2 flex items-center gap-2 text-xs text-gray-400">
                                    {note.isMe && <img src="https://picsum.photos/id/1005/50/50" className="w-4 h-4 rounded-full"/>}
